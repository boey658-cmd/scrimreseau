...
export const fr = {
  ...
  'dev.excludeAdded': "✅ **Serveur masqué du site**\n**Serveur :** {name}\n**ID :** `{id}`\n**Raison :** {reason}",
  'dev.excludeAddedNoReason': "✅ **Serveur masqué du site**\n**Serveur :** {name}\n**ID :** `{id}`",
  'dev.excludeAlready': "ℹ️ Ce serveur est déjà masqué du site.\n**Serveur :** {name}\n**ID :** `{id}`",
  'dev.excludeRemoved': "✅ **Serveur de nouveau visible sur le site**\n**Serveur :** {name}\n**ID :** `{id}`\nIl pourra réapparaître sur `/network` au prochain refresh du cache API (max ~10 min).",
  'dev.excludeNotFound': "ℹ️ Ce serveur n’est pas actuellement masqué du site.\n**ID :** `{id}`",
  'dev.excludeNone': "Aucun serveur n’est actuellement masqué du site.",
  'dev.excludeListTitle': "🚫 **Serveurs masqués du site** ({count})",
  'dev.excludeListEntry': "{idx}. **{name}**\n   ID : `{id}`\n   Raison : {reason}",
  'dev.excludeListEntryNoReason': "{idx}. **{name}**\n   ID : `{id}`\n   Raison : —",
  'dev.excludeInvalidGuild': "❌ Serveur invalide ou introuvable dans le cache du bot. Utilise l’autocomplete.",
  'dev.excludeDbError': "❌ Erreur base de données lors de la gestion des exclusions.",
